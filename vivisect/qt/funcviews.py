...
class FuncCallsView(QtGui.QWidget):
    def __init__(self, vw, parent=None):
        ...
        #self.graphview.scene().setBackgroundBrush( QtGui.QBrush( QtGui.QColor( 0x000000 ) ) )
        self.setLayout( VBox( self.graphview ) )

        #self.graphview._sig_NodeSelected.connect( self.proplab.setNucNode )
        #self.graphview._sig_NodeContextMenu.connect( self._graphContextMenu )
